...
import { FaRecycle, FaMicrochip, FaUserFriends, FaAjust } from 'react-icons/fa'
...
const showMenu = () => {
    ...
    if (toggleMenu) {
        ...
        menuItems.classList.remove('menu-items-animation-end')
        menuItems.style.WebkitAnimation = 'menu-items .2s 1.5s ease-in-out forwards'
        ...
        menuItems.classList.add('menu-items-animation-end')
...
const playerCPU = (props) => {
    return (
        <button onClick={() => props.playerCPU && props.twoPlayer()} className="button-items">
    ...
    return (
        <button className="button-items dark">
            <div className="flex-center">
                <span className="menu-icon"><FaAjust className="dark-icon"/></span> Dark Mode
            </div>
            <div className="flex-center">
...
const hamburgerMenu = (props) => {
    return (
        <div className="hamburger-menu">
            <div className="hamburger-bar-1" id="bar-1">
