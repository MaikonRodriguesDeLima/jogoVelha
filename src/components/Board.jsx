...
export default props => {
    ...
    const initialGame = [0,0,0,0,0,0,0,0,0]
    ...
    const [ win, setWins ] = useState([0,0])
    ...
    const reset = () => {
        ...
        if (setToggleInkBoardAnimation){
            inkBoard[0].style.WebkitAnimation = 'path-blur-reset .5s forwards'
            inkBoardPath[0].style.WebkitAnimation = 'path-color-reset 2s forwards'
    ...
    const winner = (gameTemp) => {
        if (gameTemp[0] === 1 && gameTemp[1] === 1 && gameTemp[2] === 1) {
            ...
            addWins(0)
            setPositionLine([2,49,98,49.5])
            return
        } else if (gameTemp[6] === 1 && gameTemp[7] === 1 && gameTemp[8] === 1){
            addWins(0)
            setPositionLine([2,82,98,82.5])
            return
